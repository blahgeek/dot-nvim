...
" Custom by blahgeek
let s:p.normal.success = [ [ s:base03, s:blue ] ]
let s:p.normal.loading = [ [ s:base03, s:green ] ]

let g:lightline#colorscheme#solarized_mod#palette = lightline#colorscheme#flatten(s:p)
